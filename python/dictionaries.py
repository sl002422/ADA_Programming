...
#первый вариант функции будет не работать потому что zip вернёт дрисню (при v в сортировке зип перевернёт результат)
#вариант с itemgetter не будет работать с george пока мы не сделаем str(1943)
#%%
# print(songs.items())
# (lambda x: (x, x ** 2))(3)
# (lambda x: [y for y in x])('George')
# (lambda x: [y for y in x])(['George', 'Bruh', 'Wasap'])
