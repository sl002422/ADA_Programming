...
class Musician:
    ...
    # pair of methods by which we access the attributes:
    @property # it wraps the method: in such a way of copying to protected __name and back
    def name(self):
        return self.__name # __name is a hidden field, it is the copy of name

    @name.setter # this is so called setter
    def name(self, name):
        self.__name = name if isinstance(name, str) else 'unknown'

    # Add an immutable property (no setter for it)
    # @property # this is so called getter
    ...
    @classmethod # refers to the class where the method is inserted
    def from_str(cls, musician_string):     # this is the method inside the class
...
# print(george.is_band_member)
# print(george._Musician__name) # we can acces it which brings the python total unsafety
# print(george.__n)
# print(george._m)
# print(george.immutable_property)
# immutable_property = 'gggg'
# print(george.immutable_property)
#%%
# Run setters and getters in the debugger
...
print((1).__dir__())        # hidden methods of int class
...
george = Musician('George Harrison')
print(george)
george1 = str(george)
print(george1)
print()
print(Musician.from_str(george1))
#print(Musician.from_str(george1))
george2 = Musician.from_str(george1)
print(type(george2))
print(george2)
...
class Singer(Musician):
    ...
    def __str__(self):
        ...
        return super().__str__() + v        # gives a string representation of mother class + v
...
class Songwriter(Musician):
    ...
    def __init__(self, instrument=Instrument.RHYTHM_GUITAR, **kwargs):
        super().__init__(**kwargs)      # (name, is_band_member)
        self.instrument = instrument if isinstance(instrument, Instrument) else None
...
print(george)
print(george.__dir__())
print(Singer.__mro__)       # method resolution order -> means the oder in what to search for methods (here first is Singer, second is Musician)
...
#%%
# def is_beattle (a):
#     if a in ['Paul', 'George', 'Ringo', 'Jone']:
#         return True
#     else:
#         return False
# a = ['Paul', 'George', 'Ringo', 'Jone', 'Marko Polo', 'imposter']
# c = list(map(is_beattle, a))
# print(c)